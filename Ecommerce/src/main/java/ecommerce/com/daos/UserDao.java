...
public class UserDao {
	...
	public static void deactivateUserById(int userId) throws SQLException {
	    try {
	        Connection connection = DatabaseConnection.getConnection();
	        PreparedStatement statement = connection.prepareStatement("UPDATE users SET activated = 0 WHERE user_id = ?");
	        statement.setInt(1, userId);
	        statement.executeUpdate();
	    } finally {
	        DatabaseConnection.closeConnection();
