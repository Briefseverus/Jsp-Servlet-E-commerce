...
public class UserDao {
	...
	public static User authenticate(String username, String password) throws SQLException {
	    ...
	    try {
	        connection = DatabaseConnection.getConnection();
	        statement = connection.prepareStatement("SELECT u.user_id, u.username, u.password, u.full_name, u.email, u.phone_number, ur.role_id FROM users u JOIN user_role ur ON u.user_id = ur.user_id WHERE u.username = ? AND u.password = ?");
